package com.codepath.twittertimeline;
...
import com.codepath.twittertimeline.utils.Constants;
...
public class TwitterClient extends OAuthBaseClient {
	...
	//Home Timeline
	public void getMentionsTimeline(boolean isInitial, long id, AsyncHttpResponseHandler handler){
	...
	public void getUserInfo(boolean current, String screenName, AsyncHttpResponseHandler handler){
		String apiUrl = "";
		RequestParams params = new RequestParams();
		if(current){
	...
	public void getFollowersList(boolean isFollowers, String screenName, String nextCursor, AsyncHttpResponseHandler handler){
		String apiUrl = "";
		RequestParams params = new RequestParams();
		params.put("screen_name",screenName);
